...
ALTER TABLE `pedido` CHANGE `data_cadastro` `data_cadastro` DATETIME NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `pedido_produto` CHANGE `data_cadastro` `data_cadastro` DATETIME NULL DEFAULT CURRENT_TIMESTAMP;
